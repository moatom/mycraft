...
void ShaderManager::setUniformM4f(const char* name, glm::f32* valuePtr)
{
...
GLuint ShaderManager::makeBOID(std::array<Vertex, 4*6>& cube, std::array<GLuint, 6*6>& cubeIndex, Image image)
{
...
void ShaderManager::attachObjects(GLuint vao, std::vector<glm::vec3>&offsets)
{
  BOID &boid = BOIDs[vao];
